...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case minion:
      minionEffect(state, handPos, currentPlayer, choice1, choice2);
      return 0;

    case steward:
      stewardEffect(choice1, choice2, choice3, state, currentPlayer, handPos);
      return 0;
...
int minionEffect(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2) {
  //+1 action
  state->numActions++;
